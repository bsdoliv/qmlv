        ...
        Column {
            ...
            Column {
                ...
                Grid {
                    ...
                    Button { width: grid.w; height: column.h; operation: "1"; color: '' }
                    ...
                    Button {  width: grid.w; height: column.h; color: 'purple'; operation: "DEL" }
                    Button { width: grid.w; height: column.h; operation: "0"; color: 'blue' ;transformOrigin: Item.Right }
                    Button {  width: grid.w; height: column.h; color: 'green'; operation: "OK" }
                }
            }
        }
